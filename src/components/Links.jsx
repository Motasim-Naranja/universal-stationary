...
const Links = () => {
    return (
        <footer className="bg-gray-800 text-white py-12">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap justify-between space-y-12 sm:space-y-0">

                    {/* About Us Section */}
                    <div className="w-full sm:w-1/3 mb-8 sm:mb-0">
                        <h4 className="font-bold text-lg mb-4">About Universal Stationary</h4>
                    ...
                    {/* Quick Links Section */}
                    <div className="w-full sm:w-1/3 mb-8 sm:mb-0">
                        <h4 className="font-bold text-lg mb-4 text-center sm:text-left">Quick Links</h4>
                        <ul className="text-sm flex flex-col items-center sm:items-start space-y-3">
                            <li><Link to="/" className="hover:underline">Home</Link></li>
                            <li><Link to="/products" className="hover:underline">Products</Link></li>
                            <li><Link to="/brands" className="hover:underline">Brands</Link></li>
                            <li><Link to="/about_us" className="hover:underline">About Us</Link></li>
                    ...
                    <div className="w-full sm:w-1/3">
                        ...
                        <p className="text-sm mb-3 leading-relaxed">Address: Suite # 213, 2nd Floor, Progressive Center, PECHS Block 6, Main Shahrah-e-Faisal, Karachi, Pakistan.</p>
                        <p className="text-sm mb-3">Phone: +92-300-2066368</p>
                        <p className="text-sm mb-3">Email: <a href="mailto:info@universalstationary.com" className="hover:underline">info@universalstationary.com</a></p>
                        <div className="mt-4 flex space-x-4">
                            <a href="https://web.facebook.com/motasim.naranja" target='_blank' rel="noopener noreferrer" className="text-white hover:text-gray-400"><FaFacebook size={20} /></a>
                            <a href="https://www.linkedin.com/in/motasim-ejaz-979342260/" target='_blank' rel="noopener noreferrer" className="text-white hover:text-gray-400"><FaLinkedin size={20} /></a>
                            <a href="https://www.instagram.com/motasim_naranja/" target='_blank' rel="noopener noreferrer" className="text-white hover:text-gray-400"><FaInstagram size={20} /></a>
                        </div>
                    </div>
